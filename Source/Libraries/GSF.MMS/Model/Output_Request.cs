...
namespace GSF.MMS.Model
{
    ...
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(Output_Request));
        private ICollection<MMSString> listOfOutputData_;
        ...
        public ICollection<MMSString> ListOfOutputData
        {
            get
            {
