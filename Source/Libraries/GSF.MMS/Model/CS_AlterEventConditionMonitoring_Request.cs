...
namespace GSF.MMS.Model
{
    ...
    [ASN1PreparedElement]
    [ASN1Sequence(Name = "CS_AlterEventConditionMonitoring_Request", IsSet = false)]
    public class CS_AlterEventConditionMonitoring_Request : IASN1PreparedElement
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(CS_AlterEventConditionMonitoring_Request));
