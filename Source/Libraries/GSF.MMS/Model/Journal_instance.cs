...
namespace GSF.MMS.Model
{
    ...
    [ASN1PreparedElement]
    [ASN1Sequence(Name = "Journal_instance", IsSet = false)]
    public class Journal_instance : IASN1PreparedElement
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(Journal_instance));
        ...
        public class DefinitionChoiceType : IASN1PreparedElement
        {
            ...
            public class DetailsSequenceType : IASN1PreparedElement
            {
                ...
                private ICollection<Journal_Entry_instance> entries_;
                ...
                [ASN1SequenceOf(Name = "entries", IsSetOf = false)]
                [ASN1Element(Name = "entries", IsOptional = false, HasTag = true, Tag = 4, HasDefaultValue = false)]
                public ICollection<Journal_Entry_instance> Entries
                {
                    get
                    {
                        return entries_;
