...
namespace GSF.MMS.Model
{
    ...
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(AcknowledgeEventNotification_Request));
        ...
        public EventTime TimeOfAcknowledgedTransition
        {
            ...
            set
            {
                timeOfAcknowledgedTransition_ = value;
            }
        }
