...
namespace GSF.MMS.Model
{
    ...
    [ASN1PreparedElement]
    [ASN1BoxedType(Name = "CS_DefineEventCondition_Request")]
    public class CS_DefineEventCondition_Request : IASN1PreparedElement
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(CS_DefineEventCondition_Request));
        private CS_DefineEventCondition_RequestChoiceType val;


        [ASN1Element(Name = "CS-DefineEventCondition-Request", IsOptional = false, HasTag = true, Tag = 0, HasDefaultValue = false)]
        public CS_DefineEventCondition_RequestChoiceType Value
        {
            get
            {
                return val;
        ...
        [ASN1PreparedElement]
        [ASN1Choice(Name = "CS-DefineEventCondition-Request")]
        public class CS_DefineEventCondition_RequestChoiceType : IASN1PreparedElement
        {
            private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(CS_DefineEventCondition_RequestChoiceType));
            private long index_;
