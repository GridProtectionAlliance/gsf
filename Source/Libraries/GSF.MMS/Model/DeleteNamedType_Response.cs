...
namespace GSF.MMS.Model
{
    ...
    [ASN1PreparedElement]
    [ASN1Sequence(Name = "DeleteNamedType_Response", IsSet = false)]
    public class DeleteNamedType_Response : IASN1PreparedElement
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(DeleteNamedType_Response));
