...
namespace GSF.MMS.Model
{
    ...
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(Named_Variable_List_instance));
        ...
        public class DefinitionChoiceType : IASN1PreparedElement
        {
            ...
            public class DetailsSequenceType : IASN1PreparedElement
            {
                ...
                private ICollection<Variable_List_Item_instance> listOfVariables_;
                ...
                public ICollection<Variable_List_Item_instance> ListOfVariables
                {
                    get
                    {
