...
namespace GSF.MMS.Model
{
    ...
    [ASN1PreparedElement]
    [ASN1Sequence(Name = "LoadUnitControlFromFile_Request", IsSet = false)]
    public class LoadUnitControlFromFile_Request : IASN1PreparedElement
    {
        private static readonly IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(typeof(LoadUnitControlFromFile_Request));
