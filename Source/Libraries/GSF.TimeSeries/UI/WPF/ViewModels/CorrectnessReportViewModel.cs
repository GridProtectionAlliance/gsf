//******************************************************************************************************
//  CorrectnessReportViewModel.cs - Gbtc
//
...
{
    /// <summary>
    /// View model for the <see cref="CorrectnessReportUserControl"/>.
    /// </summary>
    public class CorrectnessReportViewModel : ViewModelBase, IDisposable
    {
        #region [ Members ]
        ...
        public class AvailableReport
        {
            ...
            // Fields
            private CorrectnessReportViewModel m_parent;
            ...
            /// </summary>
            internal AvailableReport(CorrectnessReportViewModel parent)
            {
                m_parent = parent;
            }
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="CorrectnessReportViewModel"/> class.
        /// </summary>
        public CorrectnessReportViewModel()
        {
        ...
        /// <summary>
        /// Releases all the resources used by the <see cref="CorrectnessReportViewModel"/> object.
        /// </summary>
        public void Dispose()
        {
            WindowsServiceClient serviceClient;
