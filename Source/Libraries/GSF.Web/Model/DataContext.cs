...
namespace GSF.Web.Model
{
    ...
    public class DataContext : IDisposable
    {
        ...
        /// </summary>
        internal Dictionary<Type, ITableOperations> TableOperationsCache => m_tableOperationsCache;
        ...
        public TableOperations<TModel> Table<TModel>() where TModel : class, new()
        {
            ...
            return m_tableOperationsCache.GetOrAdd(typeof(TModel), type =>
            {
        ...
        public ITableOperations Table(Type model)
        {
            ...
            return m_tableOperationsCache.GetOrAdd(model, type =>
            {
                DataTable primaryKeyCache;
        ...
        /// <param name="noRecordText">Text for no records option when select query returns no values; defaults to "No records".</param>
        /// <returns>Generated HTML for new text field based on modeled table field attributes.</returns>
        public string AddSelectFieldFromEnum<TModel, TOption>(string fieldName,  string fieldLabel = null, string fieldID = null, string groupDataBinding = null, string labelDataBinding = null, string requiredDataBinding = null, string customDataBinding = null, string dependencyFieldName = null, string optionDataBinding = null, string toolTip = null, bool initialFocus = false, bool allowUnset = false, string unsetCaption = "Select value...", bool addEmptyRow = false, string emptyRowValue = "", bool showNoRecordOption = false, string noRecordValue = "-1", string noRecordText = "No records") where TModel : class, new() where TOption : struct, IConvertible
        {
            if (string.IsNullOrEmpty(fieldLabel))
            {
                LabelAttribute labelAttribute;
            ...
            AddFieldValueInitializer<TModel>(fieldName);
            return AddSelectFieldFromEnum<TOption>(fieldName, Table<TModel>().FieldHasAttribute<RequiredAttribute>(fieldName),
                 fieldLabel, fieldID, groupDataBinding, labelDataBinding, requiredDataBinding, customDataBinding, dependencyFieldName, optionDataBinding, toolTip, initialFocus, allowUnset, unsetCaption, addEmptyRow, emptyRowValue, showNoRecordOption, noRecordValue, noRecordText);
        }
        ...
        /// <param name="noRecordText">Text for no records option when select query returns no values; defaults to "No records".</param>
        /// <returns>Generated HTML for new text field based on specified parameters.</returns>
        public string AddSelectFieldFromEnum<TOption>(string fieldName, bool required, string fieldLabel = null, string fieldID = null, string groupDataBinding = null, string labelDataBinding = null, string requiredDataBinding = null, string customDataBinding = null, string dependencyFieldName = null, string optionDataBinding = null, string toolTip = null, bool initialFocus = false, bool allowUnset = false, string unsetCaption = "Select value...", bool addEmptyRow = false, string emptyRowValue = "", bool showNoRecordOption = false, string noRecordValue = "-1", string noRecordText = "No records") where TOption : struct, IConvertible
        {
            RazorView addSelectFieldTemplate = new RazorView(m_razorEngine, AddSelectFieldTemplate, m_exceptionHandler);
            DynamicViewBag viewBag = addSelectFieldTemplate.ViewBag;
            Dictionary<string, string> options = new Dictionary<string, string>();
