...
public class IndexingAgent {
	...
	public static final org.apache.commons.logging.Log LOG = LogFactory.getLog(IndexingAgent.class);
...
//        if (It.hasNext()) {
        ...
        LOG.info( "Indexer > Summary > Total Bytes Uploaded: " + lBytesUploaded + ", Buckets Updated: " + iBucketsUpdated );
	...
	// TODO: make it happen
	public static void Scan_HDFS_ForIndexingPass( String strHdfsURI ) {
		
		// scan through directory structure...
		
	}
	
	public static void DebugBucket( String strBucketKey ) {
		
		IndexBucket bucket = null;
		
		try {
			
			bucket = HBaseRestInterface.GetIndexBucketByKey( strBucketKey );
	...
	public static void CheckForIndexedArchive( String strHdfsPath ) {
		
		System.out.println( "\n\nChecking for indexed archive: " + strHdfsPath + "\n" );
		
    	try {
		
    		if ( HistorianArchiveFile.ArchiveExists( strHdfsPath ) ) {
				
				System.out.println( "Archive exists in HDFS store" );
				
			} else {
				
				System.out.println( "Archive does not exist in HDFS store" );
				
			}
    		
    		CheckLookupTableForPath( strHdfsPath );
	...
	public static void CheckLookupTableForPath( String strHdfsPath ) {
		...
		if ( strFileID_Ret.equals( "" ) ) {
			...
			System.out.println( "Archive does exists in reverse lookup table" );
	...
	public static void DeleteArchiveLookupPointers( String strHdfsPath ) {
	
		if ( HistorianArchiveLookupTable.Delete_HBase_LookupTableEntries( strHdfsPath ) ) {
			
			System.out.println( "LookupTable > Entries for path have been deleted: " + strHdfsPath );
			
		} else {
			
			System.out.println( "LookupTable > Entries for path have NOT been deleted: " + strHdfsPath );
	...
	public static void DebugSparkyConfig() {
		...
		System.out.println( "Debugging Sparky Configuration ------ " );
		System.out.println( "> sparky.http.port: " + conf.get("sparky.http.port") );
	...
	public static void PrintUsage() {
		...
		System.out.println( "" );
		System.out.println( "IndexingAgent: usage ---- " );
		System.out.println( "\tScan specific HDFS File: 	[-indexFile <hdfs_path>]");
		System.out.println( "\tDebug Index Bucket: 		[-debugBucket <bucket_key>]");
		System.out.println( "\tQuery Test:		 	[-query <q>]");
		System.out.println( "\tCheck For Archive: 		[-checkForArchive <hdfs_path>]");
		System.out.println( "\tDebug Lookup Tables:		[-debugLookupTable <hdfs_path>]");
		System.out.println( "\tDebug Configuration:		[-debugConfig]");
		System.out.println( "" );
