 ...
 *
 */
public class DatAwareRecordReader implements RecordReader<LongWritable, StandardPointFile> {

	private static final Log LOG = LogFactory.getLog("TVA.Hadoop.MapReduce.DatAware.DatAwareRecordReader");
	 ...
	 */
	public DatAwareRecordReader(Configuration conf_job, FileSplit split) throws IOException {
		...
		LOG.info("DatAwareRecordReader> Split Path: " + path );
