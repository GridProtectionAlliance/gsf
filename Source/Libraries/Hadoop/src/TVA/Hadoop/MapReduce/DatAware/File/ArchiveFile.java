...
public class ArchiveFile {
	...
	/**
	 * ArchiveFile.Reader
	 * -	methods needed in general
	 * 
	 * 		-	core methods wrt a Reader, used externally from RecordReader
	 * 			-	next(k)				[ need ]
	 * 			-	getCurrentValue()	[ need ]
	 * 			-	seek()
	 * 			-	getPosition()
	 * 			-	close()
	 * 
	 ...
	 * 			-	sync()
	 * 
	 * 		-	methods related to setting up a sequence-type file
	 * 
	 * 			-	openFile()	-> used internally in ctor of Reader
	 * 			-	init()		-> used internally in ctor of Reader
	 * 
	 * 		-	
	 * 
	 */
	public static class Reader implements java.io.Closeable {
		...
		private static final Log LOG = LogFactory.getLog("TVA.Hadoop.MapReduce.ArchiveFile.Reader");
