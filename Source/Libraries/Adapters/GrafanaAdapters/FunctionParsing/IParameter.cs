...
public interface IParameter
{
    ...
    /// </summary>
    /// <remarks>
    /// This method is only valid for non-definition parameters.
    /// </remarks>
    void SetValue<TDataSourceValue>(DataSet metadata, object value, string target, Dictionary<string, string> metadataMap) where TDataSourceValue : struct, IDataSourceValue<TDataSourceValue>;
}

/// <summary>
/// Defines a common interface for parameters of a specific type that can hold a value.
/// </summary>
