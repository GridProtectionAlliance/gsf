...
namespace GrafanaAdapters.GrafanaFunctions
{
    ...
    /// </remarks>
    public class Modulo : IGrafanaFunction
    {
        /// <inheritdoc />
        public string Name { get; } = "Modulo";

        /// <inheritdoc />
        public string Description { get; } = "Returns a series of values that represent each of the values in the source series modulo by N.";

        /// <inheritdoc />
        public Type Type { get; } = typeof(Modulo);

        /// <inheritdoc />
        public Regex Regex { get; } = new Regex(string.Format(FunctionsModelHelper.ExpressionFormat, "(Modulo|Modulus|Mod)"), RegexOptions.Compiled | RegexOptions.IgnoreCase);
