...
/// </remarks>
public class SliceSubtract: GrafanaFunctionBase
{
    /// <inheritdoc />
    public override string Name => nameof(SliceSubtract);

    /// <inheritdoc />
    public override string Description => "Returns a series of values that represent each of the values in the source series subtracted with another series of values.";
