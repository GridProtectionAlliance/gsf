...
/// </remarks>
public class SliceMultiply: GrafanaFunctionBase
{
    /// <inheritdoc />
    public override string Name => nameof(SliceMultiply);

    /// <inheritdoc />
    public override string Description => "Returns a series of values that represent each of the values in the source series multiplied with another series of values.";
