...
namespace GrafanaAdapters.GrafanaFunctions
{
    ...
    /// </remarks>
    public class SliceMultiply : IGrafanaFunction
    {
        /// <inheritdoc />
        public string Name { get; } = "SliceMultiply";

        /// <inheritdoc />
        public string Description { get; } = "Returns a series of values that represent each of the values in the source series multiplied with another series of values.";

        /// <inheritdoc />
        public Type Type { get; } = typeof(SliceMultiply);

        /// <inheritdoc />
        public Regex Regex { get; } = new Regex(string.Format(FunctionsModelHelper.ExpressionFormat, "SliceMultiply"), RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SliceMultiply"/> class.
        /// </summary>
        public SliceMultiply() { }
    }
}
