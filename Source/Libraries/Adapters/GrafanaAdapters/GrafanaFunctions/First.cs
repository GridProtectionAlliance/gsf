...
namespace GrafanaAdapters.GrafanaFunctions
{
    ...
    /// </remarks>
    public class First : IGrafanaFunction
    {
        /// <inheritdoc />
        ...
        /// <inheritdoc />
        public Type Type { get; } = typeof(First);

        /// <inheritdoc />
        public Regex Regex { get; } = new Regex(string.Format(FunctionsModelHelper.ExpressionFormat, "First"), RegexOptions.Compiled | RegexOptions.IgnoreCase);
