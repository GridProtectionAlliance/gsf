...
/// </remarks>
public class SliceDivide: GrafanaFunctionBase
{
    /// <inheritdoc />
    public override string Name => nameof(SliceDivide);

    /// <inheritdoc />
    public override string Description => "Returns a series of values that represent each of the values in the source series divided with another series of values.";
