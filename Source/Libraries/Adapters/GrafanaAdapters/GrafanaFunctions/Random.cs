...
namespace GrafanaAdapters.GrafanaFunctions
{
    ...
    /// </remarks>
    public class Random : IGrafanaFunction
    {
        /// <inheritdoc />
        public string Name { get; } = "Random";

        /// <inheritdoc />
        public string Description { get; } = "Returns a series of N, or N% of total, values that are a random sample of the values in the source series.";

        /// <inheritdoc />
        public Type Type { get; } = typeof(Random);

        /// <inheritdoc />
        public Regex Regex { get; } = new Regex(string.Format(FunctionsModelHelper.ExpressionFormat, "(Random|Rand|Sample)"), RegexOptions.Compiled | RegexOptions.IgnoreCase);
