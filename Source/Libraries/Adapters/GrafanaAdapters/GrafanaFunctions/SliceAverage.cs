...
namespace GrafanaAdapters.GrafanaFunctions
{
    ...
    /// </remarks>
    public class SliceAverage : IGrafanaFunction
    {
        /// <inheritdoc />
        public string Name { get; } = "SliceAverage";

        /// <inheritdoc />
        public string Description { get; } = "Returns a series of values that represent each of the values in the source series averaged with another series of values.";

        /// <inheritdoc />
        public Type Type { get; } = typeof(SliceAverage);

        /// <inheritdoc />
        public Regex Regex { get; } = new Regex(string.Format(FunctionsModelHelper.ExpressionFormat, "(SliceAverage|SliceAvg|SliceMean)"), RegexOptions.Compiled | RegexOptions.IgnoreCase);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SliceAverage"/> class.
        /// </summary>
        public SliceAverage() { }
    }
}
