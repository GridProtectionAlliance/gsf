...
namespace SELPDCImporter
{
    ...
    /// use <see cref="System.Windows.Forms.Control.Invoke(System.Delegate)"/>.
    /// </para>
    /// <para>
    ...
    public sealed class Settings : CategorizedSettingsBase<Settings>
    {
        ...
        /// <summary>
        /// Gets or sets the GPA synchrophasor product host configuration file.
        /// </summary>
        [TypeConvertedValueExpression("Form.textBoxHostConfig.Text")]
        [Description("GPA synchrophasor product host configuration file.")]
