    ...
    public partial class EditDetails : Form
    {
        ...
        private void EditDetails_Load(object sender, EventArgs e)
        {
            ...
            textBoxTCFConnectionName.TextChanged += (_, _) =>
            {
                ...
                bool matchesSCF = string.Equals(textBoxTCFConnectionName.Text, textBoxACFConnectionName.Text);
                ...
                textBoxACFConnectionName.BackColor = matchesSCF ? m_matchedColor : m_unmatchedColor;
