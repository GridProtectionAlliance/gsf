...
namespace APPPDCImporter
{
    public partial class MainForm : Form
    {
        ...
        private void APPPDCImporter_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void APPPDCImporter_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                m_formClosing = true;
        ...
        private void APPPDCImporter_FormClosed(object sender, FormClosedEventArgs e)
        {
            m_settings?.Dispose();
        }
        ...
        private void buttonAnalyze_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    m_importParams.APPPDCConfigFrame = APPPDCConfig.Parse(pdcConfigFile, (message, title, buttons, icon) => MessageBox.Show(this, message, title, buttons, icon));
                }
                catch (Exception ex)
                {
        ...
        private void comboBoxIPAddresses_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(connectionString) && comboBoxIPAddresses.SelectedItem is KeyValuePair<string, string> kvp)
            {
                ...
                textBoxConnectionString.Text = connectionString.Replace(APPPDCConfig.IPAddressToken, kvp.Value);
                m_connectionStringManuallyEdited = false;
            }
        }
