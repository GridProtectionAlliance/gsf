...
namespace LogFileViewer.Menu
{
    public class MessageMenu
    {
        ...
        public MessageMenu(List<LogMessage> selectedLogMessages)
        {
        ...
        public IEnumerable<Tuple<string, Func<LogMessageFilter>>> GetMenuButtons()
        {
            return new[]
                   {
                       Tuple.Create<string, Func<LogMessageFilter>>("Message", Message),
                       Tuple.Create<string, Func<LogMessageFilter>>("Message And Event", MessageAndEvent),
                       Tuple.Create<string, Func<LogMessageFilter>>("Message And Related Type", MessageAndRelatedType),
                       Tuple.Create<string, Func<LogMessageFilter>>("Message And Assembly", MessageAndAssembly),
                   };
        }
