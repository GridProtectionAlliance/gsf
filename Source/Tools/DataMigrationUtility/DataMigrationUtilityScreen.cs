            ...
            if (m_verifiedConnectionStringReplacement)
            {
                ...
                switch ((DatabaseType)index)
                {
                    ...
                    case DatabaseType.SQLite:
                        destination.Text = "Data Source=databaseName.db; Version=3; DataProviderString={AssemblyName={System.Data.SQLite, Version=1.0.79.0, Culture=neutral, PublicKeyToken=db937bc2d44ff139}; ConnectionType=System.Data.SQLite.SQLiteConnection; AdapterType=System.Data.SQLite.SQLiteDataAdapter}";
                        break;
                    default:
                        destination.Text = "";
                        break;
