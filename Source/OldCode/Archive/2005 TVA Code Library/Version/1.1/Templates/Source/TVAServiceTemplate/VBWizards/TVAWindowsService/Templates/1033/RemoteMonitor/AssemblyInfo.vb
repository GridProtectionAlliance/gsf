...
<Assembly: AssemblyTitle("[!output PROJECT_NAME] Remote Monitor")> 
<Assembly: AssemblyDescription("[!output PROJECT_NAME] GUI Application Based Remote Service Monitor")> 
