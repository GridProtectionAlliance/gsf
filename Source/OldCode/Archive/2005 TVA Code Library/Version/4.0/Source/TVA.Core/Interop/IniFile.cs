...
namespace TVA.Interop
{
    ...
    public class IniFile
    {
        ...
        private string RemoveComments(string keyValue)
        {
        ...
        [DllImport("kernel32", EntryPoint = "GetPrivateProfileSectionA", ExactSpelling = true, CharSet = CharSet.Ansi, SetLastError = true)]
