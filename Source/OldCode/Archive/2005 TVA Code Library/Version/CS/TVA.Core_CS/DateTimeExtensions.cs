//*******************************************************************************************************
//  TVA.DateTimeExtensions.vb - Defines extension functions related to DateTimes
...
namespace TVA
{
	...
	public static class DateTimeExtensions
	{
		...
		/// <exception cref="ArgumentOutOfRangeException">LagTime and LeadTime must be greater than zero, but can
		/// be less than one.</exception>
        public static bool TimeIsValid(this DateTime currentTime, DateTime testTime, double lagTime, double leadTime)
		{
		...
		/// <exception cref="ArgumentOutOfRangeException">LagTime and LeadTime must be greater than zero, but can
		/// be less than one.</exception>
        public static bool TimeIsValid(this long currentTicks, long testTicks, double lagTime, double leadTime)
		{
