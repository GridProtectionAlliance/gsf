	...
	namespace Net
	{
		namespace Ftp
		{
			...
			public class InputDataStream : DataStream
			{
				...
				internal InputDataStream(ControlChannel ctrl, System.Net.Sockets.TcpClient client) : base(ctrl, client)
				{
			...
			public class OutputDataStream : DataStream
			{
				...
				internal OutputDataStream(ControlChannel ctrl, System.Net.Sockets.TcpClient client) : base(ctrl, client)
				{
