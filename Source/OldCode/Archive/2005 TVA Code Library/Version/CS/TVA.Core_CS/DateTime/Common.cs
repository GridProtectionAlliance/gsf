...
namespace ClassLibrary1
{
	namespace DateTime
	{
		...
		public sealed class Common
		{
			...
			private static ClassLibrary1.DateTime.Win32TimeZone m_universalTimeZone;
			private static ClassLibrary1.DateTime.Win32TimeZone m_easternTimeZone;
			private static ClassLibrary1.DateTime.Win32TimeZone m_centralTimeZone;
			private static ClassLibrary1.DateTime.Win32TimeZone m_mountainTimeZone;
			private static ClassLibrary1.DateTime.Win32TimeZone m_pacificTimeZone;
			...
			public static DateTime BaselinedTimestamp(long ticks, ClassLibrary1.DateTime.Common.BaselinedTimestamp baselineTo)
			{
			...
			public static ClassLibrary1.DateTime.Common.GetWin32TimeZone GetWin32TimeZone(string standardName)
			{
			...
			public static ClassLibrary1.DateTime.Common.GetWin32TimeZone GetWin32TimeZone(string name, ClassLibrary1.DateTime.Common.GetWin32TimeZone lookupBy)
			{
				
				foreach (Win32TimeZone timeZone in TimeZones.GetTimeZones)
				{
					if (lookupBy == TimeZoneName.DaylightAbbreviation)
					{
					...
					else if (lookupBy == TimeZoneName.DaylightName)
					{
					...
					else if (lookupBy == TimeZoneName.StandardAbbreviation)
					{
			...
			public static UniversalTimeZone UniversalTimeZone
			{
				get
				{
			...
			public static EasternTimeZone EasternTimeZone
			{
				get
				{
			...
			public static CentralTimeZone CentralTimeZone
			{
				get
				{
			...
			public static MountainTimeZone MountainTimeZone
			{
				get
				{
			...
			public static PacificTimeZone PacificTimeZone
			{
				get
				{
			...
			/// <para>Timestamp in specified time zone.</para>
			/// </returns>
			public static DateTime LocalTimeTo(DateTime localTimestamp, ClassLibrary1.DateTime.Common.LocalTimeTo destinationTimeZone)
			{
				
				double destOffset;
				
				// Calculates exact UTC offset of destination time zone in hours.
				object with_1 = destinationTimeZone.GetUtcOffset(localTimestamp);
			...
			/// <returns>The timestamp in the specified time zone.</returns>
			public static DateTime UniversalTimeTo(DateTime universalTimestamp, ClassLibrary1.DateTime.Common.UniversalTimeTo destinationTimeZone)
			{
			...
			/// <para>Timestamp in destination time zone.</para>
			/// </returns>
			public static DateTime TimeZoneToTimeZone(DateTime timestamp, ClassLibrary1.DateTime.Common.TimeZoneToTimeZone sourceTimeZone, ClassLibrary1.DateTime.Common.TimeZoneToTimeZone destinationTimeZone)
			{
				
				double destOffset;
				
				// Calculates exact UTC offset of destination time zone in hours.
				object with_1 = destinationTimeZone.GetUtcOffset(timestamp);
				destOffset = with_1.Hours + with_1.Minutes / 60;
