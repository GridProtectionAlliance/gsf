...
namespace TVA
{
	[Serializable()]public struct Int24
	{
		...
		public const int BitMask = (Bit.Bit24 | Bit.Bit25 | Bit.Bit26 | Bit.Bit27 | Bit.Bit28 | Bit.Bit29 | Bit.Bit30 | Bit.Bit31);
		...
		public Int24(Int24 value)
		{
			...
			m_value = ApplyBitMask(System.Convert.ToInt32(value));
		...
		public Int24(byte[] value, int startIndex)
		{
			...
			m_value = ApplyBitMask(System.Convert.ToInt32(Int24.GetValue(value, startIndex)));
		...
		public static byte[] GetBytes(Int24 value)
		{
			...
			byte[] int32Bytes = BitConverter.GetBytes(System.Convert.ToInt32(value));
		...
		public static bool operator ==(int value1, Int24 value2)
		{
			...
			return value1.Equals(System.Convert.ToInt32(value2));
		...
		public static bool operator ==(Int24 value1, int value2)
		{
			...
			return System.Convert.ToInt32(value1).Equals(value2);
		...
		public static bool operator <(int value1, Int24 value2)
		{
			...
			return (value1.CompareTo(System.Convert.ToInt32(value2)) < 0);
		...
		public static explicit operator short (Int24 value)
		{
			...
			return ((short) (System.Convert.ToInt32(value)));
		...
		public static explicit operator byte (Int24 value)
		{
			...
			return ((byte) (System.Convert.ToInt32(value)));
		...
		public static Int24 operator !(Int24 value)
		{
			...
			return ((Int24) (ApplyBitMask(! System.Convert.ToInt32(value))));
		...
		public static Int24 operator &(Int24 value1, Int24 value2)
		{
			...
			return ((Int24) (ApplyBitMask(System.Convert.ToInt32(value1) && System.Convert.ToInt32(value2))));
		...
		public static int operator &(int value1, Int24 value2)
		{
			...
			return (value1 && System.Convert.ToInt32(value2));
		...
		public static int operator &(Int24 value1, int value2)
		{
			...
			return (System.Convert.ToInt32(value1) && value2);
		...
		public static Int24 operator %(Int24 value1, Int24 value2)
		{
			...
			return ((Int24) (System.Convert.ToInt32(value1) % System.Convert.ToInt32(value2)));
		...
		public static double operator /(Int24 value1, int value2)
		{
			...
			return (System.Convert.ToDouble(value1) / System.Convert.ToInt32(value2));
		...
		public static Int24 operator >>(Int24 value, int shifts)
		{
			...
			return ((Int24) (ApplyBitMask(System.Convert.ToInt32(value) >> shifts)));
		...
		public int CompareTo(Int24 value)
		{
			...
			return CompareTo(System.Convert.ToInt32(value));
		...
		public override bool Equals(object obj)
		{
			...
			{
				return Equals(System.Convert.ToInt32(obj));
			}
			return false;
		...
		public static bool TryParse(string s, ref Int24 result)
		{
			
			int parseResult;
			bool parseResponse;
			
			parseResponse = int.TryParse(s, ref parseResult);
		...
		/// System.Globalization.NumberStyles.AllowHexSpecifier and System.Globalization.NumberStyles.HexNumber values.
		/// </exception>
		public static bool TryParse(string s, NumberStyles style, IFormatProvider provider, ref Int24 result)
		{
			
			int parseResult;
			bool parseResponse;
			
			parseResponse = int.TryParse(s, style, provider, ref parseResult);
