...
namespace TVA
{
    namespace Math
    {
        ...
        public sealed class Common
        {
            ...
            [CLSCompliant(false)]
            public static UInt16 Xor16BitCheckSum(byte[] data, int startIndex, int length)
            {
            ...
            [CLSCompliant(false)]
            public static UInt32 Xor32BitCheckSum(byte[] data, int startIndex, int length)
            {
            ...
            [CLSCompliant(false)]
            public static UInt64 Xor64BitCheckSum(byte[] data, int startIndex, int length)
            {
