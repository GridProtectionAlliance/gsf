...
namespace TVA
{
	namespace Parsing
	{
		...
		public partial class BinaryDataParserBase<TIdentifier, TOutput> : System.ComponentModel.Component
		{
			...
			[System.Diagnostics.DebuggerNonUserCode()]public BinaryDataParserBase(System.ComponentModel.IContainer container) : this()
			{
			...
			[System.Diagnostics.DebuggerNonUserCode()]public BinaryDataParserBase()
			{
				...
				m_dataQueue = TVA.Collections.ProcessQueue<IdentifiableItem<Guid, byte>>.CreateRealTimeQueue(new System.EventHandler(ParseData));
