...
namespace TVA
{
	namespace Configuration
	{
		...
		public class CategorizedSettingsElement : ConfigurationElement
		{
			...
			/// </summary>
			internal CategorizedSettingsElement() : this("")
			{
			}
			...
			/// Required by the configuration API and is for internal use only.
			/// </summary>
			internal CategorizedSettingsElement(string name) : this(name, "")
			{
			}
			...
			public CategorizedSettingsElement(string name, string value) : this(name, value, "")
			{
			}
			...
			public CategorizedSettingsElement(string name, string value, string description) : this(name, value, description, false)
			{
			}
			...
			[ConfigurationProperty("name", IsKey = true, IsRequired = true)]public string Name
			{
				get
				{
			...
			[ConfigurationProperty("value", IsRequired = true)]public string Value
			{
				get
				{
			...
			[ConfigurationProperty("description", IsRequired = true)]public string Description
			{
				get
				{
			...
			[ConfigurationProperty("encrypted", IsRequired = true)]public bool Encrypted
			{
				get
				{
