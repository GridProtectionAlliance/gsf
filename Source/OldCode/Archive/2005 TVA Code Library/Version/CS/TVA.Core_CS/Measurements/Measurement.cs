...
namespace ClassLibrary1
{
	namespace Measurements
	{
		...
		public class Measurement : IMeasurement
		{
			...
			private ClassLibrary1.Measurements.MeasurementKey m_key;
			...
			public Measurement() : this(- 1, null, double.NaN, 0)
			{
				
				
			}
			
			public Measurement(int id, string source) : this(id, source, double.NaN, 0.0, 1.0, 0)
			{
			...
			public Measurement(int id, string source, double value, DateTime timestamp) : this(id, source, value, timestamp.Ticks)
			{
				
				
			}
			
			public Measurement(int id, string source, double value, long ticks) : this(id, source, value, 0.0, 1.0, ticks)
			{
				
				
			}
			
			public Measurement(int id, string source, string tagName, double adder, double multiplier) : this(id, source, double.NaN, adder, multiplier, 0)
			{
			...
			[DefaultValue(0.0)]public double Adder
			{
				get
				{
					return m_adder;
			...
			[DefaultValue(1.0)]public double Multiplier
			{
				get
				{
					return m_multiplier;
