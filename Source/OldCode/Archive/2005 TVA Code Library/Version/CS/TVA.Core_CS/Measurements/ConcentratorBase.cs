...
//						return DateTime.UtcNow.Ticks;
			...
			public virtual string Status
			{
				get
				{
					...
					with_1.Append(SecondsToText(RunTime));
					with_1.AppendLine();
					...
					if (! m_useLocalClockAsRealTime)
					{
						...
						#if UsePrecisionTimer
						with_1.Append(SecondsFromRealTime(PrecisionTimer.UtcNow.Ticks).ToString("0.0000"));
						#else
						with_1.Append(SecondsFromRealTime(DateTime.UtcNow.Ticks).ToString("0.0000"));
						#endif
					...
					with_1.AppendLine();
					with_1.Append("  Average publication time: ");
					with_1.Append(AveratePublicationTimePerFrame.ToString("0.0000"));
					with_1.Append(" milliseconds");
					with_1.AppendLine();
					with_1.Append(" User function utilization: ");
					with_1.Append((1.0 - (m_ticksPerFrame - MillisecondsToTicks(AveratePublicationTimePerFrame)) / m_ticksPerFrame).ToString("##0.0000%"));
					...
					with_1.AppendLine();
					with_1.Append("      Last published frame: ");
					...
					else
					{
						...
						with_1.AppendLine();
						with_1.Append("   Last sorted measurement: ");
