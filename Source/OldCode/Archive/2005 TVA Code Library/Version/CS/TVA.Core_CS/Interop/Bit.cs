...
namespace TVA
{
	namespace Interop
	{
		...
		public sealed class Bit
		{
			...
			public const byte Nill = 0;
			
			/// <summary>No bits set (16-bit)</summary>
			public const short Nill16 = 0;
			
			/// <summary>No bits set (32-bit)</summary>
			public const int Nill32 = 0;
			
			// Byte 0, Bits 0-7
			
			/// <summary>Bit 0 (0x00000001)</summary>
			public const byte Bit0 = 0x1; // &H00000001    00000001 = 1
			
			/// <summary>Bit 1 (0x00000002)</summary>
			public const byte Bit1 = 0x2; // &H00000002    00000010 = 2
			
			/// <summary>Bit 2 (0x00000004)</summary>
			public const byte Bit2 = 0x4; // &H00000004    00000100 = 4
			
			/// <summary>Bit 3 (0x00000008)</summary>
			public const byte Bit3 = 0x8; // &H00000008    00001000 = 8
			
			/// <summary>Bit 4 (0x00000010)</summary>
			public const byte Bit4 = 0x10; // &H00000010    00010000 = 16
			
			/// <summary>Bit 6 (0x00000020)</summary>
			public const byte Bit5 = 0x20; // &H00000020    00100000 = 32
			
			/// <summary>Bit 6 (0x00000040)</summary>
			public const byte Bit6 = 0x40; // &H00000040    01000000 = 64
			
			/// <summary>Bit 7 (0x00000080)</summary>
			public const byte Bit7 = 0x80; // &H00000080    10000000 = 128
			
			// Byte 1, Bits 8-15
			
			/// <summary>Bit 8 (0x00000100)</summary>
			public const short Bit8 = 256; // &H00000100
			
			/// <summary>Bit 9 (0x00000200)</summary>
			public const short Bit9 = 512; // &H00000200
			
			/// <summary>Bit 10 (0x00000400)</summary>
			public const short Bit10 = 1024; // &H00000400
			
			/// <summary>Bit 11 (0x00000800)</summary>
			public const short Bit11 = 2048; // &H00000800
			
			/// <summary>Bit 12 (0x00001000)</summary>
			public const short Bit12 = 4096; // &H00001000
			
			/// <summary>Bit 13 (0x00002000)</summary>
			public const short Bit13 = 8192; // &H00002000
			
			/// <summary>Bit 14 (0x00004000)</summary>
			public const short Bit14 = 16384; // &H00004000
			
			/// <summary>Bit 15 (0x00008000)</summary>
			public const short Bit15 = - 32768; // &H00008000
			
			// Byte 2, Bits 16-23
			
			/// <summary>Bit 16 (0x00010000)</summary>
			public const int Bit16 = 65536; // &H00010000
			
			/// <summary>Bit 17 (0x00020000)</summary>
			public const int Bit17 = 131072; // &H00020000
			
			/// <summary>Bit 18 (0x00040000)</summary>
			public const int Bit18 = 262144; // &H00040000
			
			/// <summary>Bit 19 (0x00080000)</summary>
			public const int Bit19 = 524288; // &H00080000
			
			/// <summary>Bit 20 (0x00100000)</summary>
			public const int Bit20 = 1048576; // &H00100000
			
			/// <summary>Bit 21 (0x00200000)</summary>
			public const int Bit21 = 2097152; // &H00200000
			
			/// <summary>Bit 22 (0x00400000)</summary>
			public const int Bit22 = 4194304; // &H00400000
			
			/// <summary>Bit 23 (0x00800000)</summary>
			public const int Bit23 = 8388608; // &H00800000
			
			// Byte 3, Bits 24-31
			
			/// <summary>Bit 24 (0x01000000)</summary>
			public const int Bit24 = 16777216; // &H01000000
			
			/// <summary>Bit 25 (0x02000000)</summary>
			public const int Bit25 = 33554432; // &H02000000
			
			/// <summary>Bit 26 (0x04000000)</summary>
			public const int Bit26 = 67108864; // &H04000000
			
			/// <summary>Bit 27 (0x08000000)</summary>
			public const int Bit27 = 134217728; // &H08000000
			
			/// <summary>Bit 28 (0x10000000)</summary>
			public const int Bit28 = 268435456; // &H10000000
			
			/// <summary>Bit 29 (0x20000000)</summary>
			public const int Bit29 = 536870912; // &H20000000
			
			/// <summary>Bit 30 (0x40000000)</summary>
			public const int Bit30 = 1073741824; // &H40000000
			
			/// <summary>Bit 31 (0x80000000)</summary>
			public const int Bit31 = - 2147483648; // &H80000000
