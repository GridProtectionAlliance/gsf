...
#Region " Variables "
    ...
    Private WithEvents m_remotingServer As CommunicationServerBase
    Private WithEvents m_statusLog As TVA.IO.LogFile
    Private WithEvents m_scheduler As TVA.Scheduling.ScheduleManager
    Private WithEvents m_exceptionLogger As TVA.ErrorManagement.GlobalExceptionLogger
...
#Region " Constants "
    ...
    ''' </summary>
    Public Const DefaultLogStatusUpdates As Boolean = True

    ''' <summary>
    ''' Default value for MonitorServiceHealth property.
    ''' </summary>
    Public Const DefaultMonitorServiceHealth As Boolean = False

    ''' <summary>
    ''' Default value for RequestHistoryLimit property.
    ''' </summary>
    Public Const DefaultRequestHistoryLimit As Integer = 50

    ''' <summary>
    ''' Default value for QueryableSettingsCategories property.
    ''' </summary>
    Public Const DefaultQueryableSettingsCategories As String = "ServiceHelper, StatusLog, ExceptionLogger"
    ...
    ''' </summary>
    Public Const DefaultSettingsCategoryName As String = "ServiceHelper"
...
#Region " Properties "
    ...
    DefaultValue(DefaultLogStatusUpdates) _
    > _
    ...
    < _
    Category("Preferences"), _
    DefaultValue(DefaultMonitorServiceHealth) _
    > _
    ...
    < _
    Category("Preferences"), _
    DefaultValue(DefaultRequestHistoryLimit) _
    > _
    ...
    < _
    Category("Preferences"), _
    DefaultValue(DefaultQueryableSettingsCategories) _
    > _
    ...
    DefaultValue(DefaultPersistSettings) _
    > _
    ...
    < _
    Category("Persistance"), _
    DefaultValue(DefaultSettingsCategoryName) _
    > _
    ...
    <Category("Components")> _
    Public Property RemotingServer() As CommunicationServerBase
        Get
            Return m_remotingServer
        End Get
        Set(ByVal value As CommunicationServerBase)
            m_remotingServer = value
        End Set
    End Property

    <Category("Components"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
    Public ReadOnly Property Scheduler() As TVA.Scheduling.ScheduleManager
        Get
            Return m_scheduler
        End Get
    End Property
    ...
    <Category("Components"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
    Public ReadOnly Property StatusLog() As TVA.IO.LogFile
        Get
            Return m_statusLog
        End Get
    End Property
    ...
    <Category("Components"), DesignerSerializationVisibility(DesignerSerializationVisibility.Content)> _
    Public ReadOnly Property ExceptionLogger() As TVA.ErrorManagement.GlobalExceptionLogger
        Get
...
#Region " Methods "
    ...
    Public Sub OnStart(ByVal args As String())
        ...
        If m_service IsNot Nothing Then
            ...
            If m_remotingServer IsNot Nothing Then
            ...
            If m_logStatusUpdates Then m_statusLog.Open()
    ...
    Public Sub OnStop()
        ...
        If m_statusLog.IsOpen Then m_statusLog.Close()
        ...
        If Not m_suppressUpdates Then
            With New StringBuilder()
                ...
                If m_logStatusUpdates Then
                    m_statusLog.WriteTimestampedLine(.ToString())
                End If
            End With
        End If
    ...
    Public Sub ScheduleProcess(ByVal processName As String, ByVal scheduleRule As String, ByVal updateExistingSchedule As Boolean)
        ...
        If Processes(processName) IsNot Nothing Then
            ...
            Dim existingSchedule As Schedule = m_scheduler.Schedules(processName)
...
#Region " Handlers "
        ...
        Else
            If m_connectedClients.Count > 0 Then
                ...
                With New StringBuilder()
                    ...
                    For Each clientInfo As ClientInfo In m_connectedClients
                        .AppendLine()
                        If Not String.IsNullOrEmpty(clientInfo.ClientName) Then
                            .Append(clientInfo.ClientName.PadRight(25))
                        Else
                            .Append("[Not Available]".PadRight(25))
                        End If
                        .Append(" "c)
                        If Not String.IsNullOrEmpty(clientInfo.MachineName) Then
    ...
    Private Sub ShowSchedules(ByVal requestInfo As ClientRequestInfo)
        ...
        If requestInfo.Request.Arguments.ContainsHelpRequest Then
            ...
            End With
        Else
            If m_scheduler.Schedules.Count > 0 Then
                ...
                With New StringBuilder()
                    ...
                    .Append(" "c)
                    .Append(New String("-"c, 30))
                    For Each schedule As Schedule In m_scheduler.Schedules
                        .AppendLine()
    ...
    Private Sub UnscheduleProcess(ByVal requestInfo As ClientRequestInfo)
        ...
        Else
            ...
            Dim doSaveSchedules As Boolean = requestInfo.Request.Arguments.Exists("save")
            Dim doListSchedules As Boolean = requestInfo.Request.Arguments.Exists("list")
            Dim scheduleToRemove As Schedule = m_scheduler.Schedules(processName)
    ...
    Private Sub m_statusLog_LogException(ByVal sender As Object, ByVal e As GenericEventArgs(Of System.Exception)) Handles m_statusLog.LogException
    ...
    Private Sub m_scheduler_ScheduleDue(ByVal sender As Object, ByVal e As ScheduleEventArgs) Handles m_scheduler.ScheduleDue
    ...
    Private Sub m_remotingServer_ClientDisconnected(ByVal sender As Object, ByVal e As GenericEventArgs(Of System.Guid)) Handles m_remotingServer.ClientDisconnected
    ...
    Private Sub m_remotingServer_ReceivedClientData(ByVal sender As Object, ByVal e As GenericEventArgs(Of IdentifiableItem(Of System.Guid, Byte()))) Handles m_remotingServer.ReceivedClientData
...
#Region " Obsolete "
    ...
    <Obsolete("Property is replaced by RemotingServer and will be deleted in version 3.3."), Browsable(False), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
    Public Property CommunicationServer() As CommunicationServerBase
        Get
            Return m_remotingServer
        End Get
        Set(ByVal value As CommunicationServerBase)
    ...
    <Obsolete("Property is replaced by StatusLog and will be deleted in version 3.3."), Browsable(False), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property LogFile() As TVA.IO.LogFile
        Get
            Return m_statusLog
        End Get
    End Property

    <Obsolete("Property is replaced by Scheduler and will be deleted in version 3.3."), Browsable(False), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property ScheduleManager() As TVA.Scheduling.ScheduleManager
        Get
            Return m_scheduler
        End Get
    End Property

    <Obsolete("Property is replaced by ExceptionLogger and will be deleted in version 3.3."), Browsable(False), EditorBrowsable(EditorBrowsableState.Never), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property GlobalExceptionLogger() As TVA.ErrorManagement.GlobalExceptionLogger
        Get
            Return m_exceptionLogger
        End Get
    End Property
