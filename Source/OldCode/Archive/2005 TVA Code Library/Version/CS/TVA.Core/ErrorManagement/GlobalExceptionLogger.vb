...
#Region " Constants "
        ...
        ''' </summary>
        Public Const DefaultAutoRegister As Boolean = True

        ''' <summary>
        ''' Default value for ExitOnUnhandledException property.
        ''' </summary>
        Public Const DefaultExitOnUnhandledException As Boolean = False

        ''' <summary>
        ''' Default value for LogToUI property.
        ''' </summary>
        Public Const DefaultLogToUI As Boolean = False
        ...
        ''' </summary>
        Public Const DefaultLogToEmail As Boolean = False

        ''' <summary>
        ''' Default value for LogToEventLog property.
        ''' </summary>
        Public Const DefaultLogToEventLog As Boolean = True

        ''' <summary>
        ''' Default value for LogToScreenshot property.
        ''' </summary>
        Public Const DefaultLogToScreenshot As Boolean = False

        ''' <summary>
        ''' Default value for SmtpServer property.
        ''' </summary>
        Public Const DefaultSmtpServer As String = SimpleMailMessage.DefaultMailServer

        ''' <summary>
        ''' Default value for ContactName property.
        ''' </summary>
        Public Const DefaultContactName As String = ""

        ''' <summary>
        ''' Default value for ContactEmail property.
        ''' </summary>
        Public Const DefaultContactEmail As String = ""

        ''' <summary>
        ''' Default value for ContactPhone property.
        ''' </summary>
        Public Const DefaultContactPhone As String = ""
        ...
        ''' </summary>
        Public Const DefaultSettingsCategoryName As String = "ErrorLogger"
...
#Region " Properties "
        ...
        <Category("Behavior"), DefaultValue(DefaultAutoRegister)> _
        ...
        <Category("Behavior"), DefaultValue(DefaultExitOnUnhandledException)> _
        ...
        <Category("Logging"), DefaultValue(DefaultLogToUI)> _
        ...
        <Category("Logging"), DefaultValue(DefaultLogToFile)> _
        ...
        <Category("Logging"), DefaultValue(DefaultLogToEmail)> _
        ...
        <Category("Logging"), DefaultValue(DefaultLogToEventLog)> _
        ...
        <Category("Logging"), DefaultValue(DefaultLogToScreenshot)> _
        ...
        <Category("Settings"), DefaultValue(DefaultSmtpServer)> _
        ...
        <Category("Settings"), DefaultValue(DefaultContactName)> _
        ...
        <Category("Settings"), DefaultValue(DefaultContactEmail)> _
        ...
        <Category("Settings"), DefaultValue(DefaultContactPhone)> _
