...
#Region " Helpers "
        ...
        Private Shared Sub FillStoredProcParameters(ByRef command As IDbCommand, ByVal connectionType As ConnectionType, ByVal parameters() As Object)
            ...
            If parameters IsNot Nothing Then
                If command.CommandText.StartsWith("SELECT ", StringComparison.CurrentCultureIgnoreCase) OrElse _
                        command.CommandText.StartsWith("INSERT ", StringComparison.CurrentCultureIgnoreCase) OrElse _
                        command.CommandText.StartsWith("UPDATE ", StringComparison.CurrentCultureIgnoreCase) OrElse _
                        command.CommandText.StartsWith("DELETE ", StringComparison.CurrentCultureIgnoreCase) Then
