...
#Region " Variables "
        ...
        Private m_previouslyEnabled As Boolean
...
#Region " Constants "
        ...
        ''' </summary>
        Public Const DefaultEnabled As Boolean = True
        ...
        ''' </summary>
        Public Const DefaultSettingsCategoryName As String = "ScheduleManager"
