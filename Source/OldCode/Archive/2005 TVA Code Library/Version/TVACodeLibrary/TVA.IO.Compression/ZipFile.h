...
namespace TVA
{
	namespace IO
	{
		namespace Compression
		{
			...
			[ToolboxBitmap(__typeof(System::Object), S"TVA.IO.Compression.ZipFile.bmp"), DefaultProperty(S"FileName"), DefaultMember(S"Files"), Description(S"Allows manipulation of compressed files in Zip format")]
