    ...
    Public NotInheritable Class TimeZones
        ...
        Private Shared Function LoadTimeZone( _
          ByVal regKeyTimeZone As RegistryKey _
            ...
            With regKeyTimeZone
                timeZoneIndex = DirectCast(.GetValue(VALUE_INDEX, -1), Int32)
                displayName = DirectCast(.GetValue(VALUE_DISPLAY_NAME, String.Empty), String)
                standardName = DirectCast(.GetValue(VALUE_STANDARD_NAME, String.Empty), String)
                daylightName = DirectCast(.GetValue(VALUE_DAYLIGHT_NAME, String.Empty), String)
                timeZoneData = DirectCast(.GetValue(VALUE_ZONE_INFO, New Byte() {}), Byte())
            End With
