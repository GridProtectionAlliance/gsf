...
#Region " Constants "
        ...
        ''' </summary>
        Public Const DefaultName As String = "LogFile.txt"

        ''' <summary>
        ''' Default value for Size property.
        ''' </summary>
        Public Const DefaultSize As Integer = 3

        ''' <summary>
        ''' Default value for AutoOpen property.
        ''' </summary>
        Public Const DefaultAutoOpen As Boolean = False

        ''' <summary>
        ''' Default value for FileFullOperation property.
        ''' </summary>
        Public Const DefaultFileFullOperation As LogFileFullOperation = LogFileFullOperation.Truncate
        ...
        ''' </summary>
        Public Const DefaultSettingsCategoryName As String = "LogFile"
...
#Region " Properties "
        ...
        < _
        Category("Settings"), _
        DefaultValue(DefaultSize), _
        Description("The size of the log file in MB.") _
        > _
        ...
        < _
        Category("Behavior"), _
        DefaultValue(DefaultAutoOpen), _
        Description("Indicates whether the log file is to be opened automatically after the component has finished initializing.") _
        > _
        ...
        < _
        Category("Behavior"), _
        DefaultValue(DefaultFileFullOperation), _
        Description("The type of operation to be performed when the log file is full.") _
        > _
        ...
        Description("Indicates whether the component settings are to be persisted to the config file.") _
        > _
        ...
        Description("The category name under which the component settings are to be saved in the config file.") _
        > _
