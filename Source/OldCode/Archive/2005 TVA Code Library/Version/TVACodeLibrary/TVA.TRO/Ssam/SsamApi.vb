...
Namespace Ssam
    ...
    Public Class SsamApi
        ...
        ''' </returns>
        <Category("Configuration"), Description("Determines whether the connection with SSAM server is to be kept open after logging an event."), DefaultValue(GetType(Boolean), "False")> _
        ...
        Public Sub Disconnect()
            ...
            Try
                ...
                With CategorizedSettings(ConfigurationElement)
                    .Add("Development", m_devConnectionString, "Connection string for connecting to development SSAM server.", True)
                    .Add("Production", m_prdConnectionString, "Connection string for connecting to production SSAM server.", True)
                End With
                SaveSettings()
            Catch ex As Exception
