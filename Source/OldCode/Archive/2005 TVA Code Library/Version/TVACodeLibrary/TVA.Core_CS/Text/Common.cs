...
namespace TVA
{
	namespace Text
	{
		...
		public sealed class Common
		{
			...
			/// </para>
			/// </remarks>
			[Obsolete("Latest .NET versions of the String.Concat function have been optimized - this function will be removed from future builds of the code library.", false)]public static string Concat(params string[] values)
			{
			...
			public static string[] GetStringSegments(string value, int segmentSize)
			{
				...
				string[] segments = TVA.Common.CreateArray<string>(totalSegments);
