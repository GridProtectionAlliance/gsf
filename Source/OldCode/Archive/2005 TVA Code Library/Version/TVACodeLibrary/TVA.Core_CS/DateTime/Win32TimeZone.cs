...
namespace TVA
{
	namespace DateTime
	{
		...
		[EditorBrowsable(EditorBrowsableState.Never), Serializable()]public class DaylightTimeChange
		{
		...
		// where I located it.
		[EditorBrowsable(EditorBrowsableState.Never)]public sealed class TimeZones
		{
...
endOfForLoop:
		...
		[Serializable()]public class Win32TimeZone : TimeZone
		{
			...
			public Win32TimeZone(int index, string displayName, TimeSpan standardOffset, string standardName, string standardAbbreviation) : this(standardOffset, standardName, standardAbbreviation)
			{
			...
			public Win32TimeZone(int index, string displayName, TimeSpan standardOffset, string standardName, string standardAbbreviation, TimeSpan daylightDelta, string daylightName, string daylightAbbreviation, DaylightTimeChange daylightTimeChangeStart, DaylightTimeChange daylightTimeChangeEnd) : this(standardOffset, standardName, standardAbbreviation, daylightDelta, daylightName, daylightAbbreviation, daylightTimeChangeStart, daylightTimeChangeEnd)
			{
