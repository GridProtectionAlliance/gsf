	...
	namespace Interop
	{
		...
		public class EndianOrder
		{
			...
			private EndianOrder(Endianness targetEndianness)
			{
				...
				if (targetEndianness == Endianness.BigEndian)
				{
					if (BitConverter.IsLittleEndian)
					{
						...
						m_copyBuffer = new System.EventHandler(SwapCopy);
						m_coerceByteOrder = new System.EventHandler(ReverseBuffer);
					}
					else
					{
						// If OS is big endian and we want big endian, we just copy the bytes
						m_copyBuffer = new System.EventHandler(BlockCopy);
						m_coerceByteOrder = new System.EventHandler(PassThroughBuffer);
					}
				}
				else
				{
			...
			public char ToChar(byte[] value, int startIndex)
			{
				...
				byte[] buffer = TVA.Common.CreateArray<byte>(2);
			...
			public double ToDouble(byte[] value, int startIndex)
			{
				...
				byte[] buffer = TVA.Common.CreateArray<byte>(8);
			...
			public int ToInt32(byte[] value, int startIndex)
			{
				...
				byte[] buffer = TVA.Common.CreateArray<byte>(4);
			...
			[CLSCompliant(false)]public UInt16 ToUInt16(byte[] value, int startIndex)
			{
			...
			[CLSCompliant(false)]public UInt32 ToUInt32(byte[] value, int startIndex)
			{
			...
			[CLSCompliant(false)]public UInt64 ToUInt64(byte[] value, int startIndex)
			{
			...
			[CLSCompliant(false)]public byte[] GetBytes(UInt16 value)
			{
			...
			[CLSCompliant(false)]public byte[] GetBytes(UInt32 value)
			{
			...
			[CLSCompliant(false)]public byte[] GetBytes(UInt64 value)
			{
			...
			public void CopyBytes(bool value, Array destinationArray, int destinationIndex)
			{
			...
			public void CopyBytes(char value, Array destinationArray, int destinationIndex)
			{
			...
			public void CopyBytes(double value, Array destinationArray, int destinationIndex)
			{
			...
			public void CopyBytes(short value, Array destinationArray, int destinationIndex)
			{
			...
			public void CopyBytes(int value, Array destinationArray, int destinationIndex)
			{
			...
			public void CopyBytes(long value, Array destinationArray, int destinationIndex)
			{
			...
			public void CopyBytes(float value, Array destinationArray, int destinationIndex)
			{
			...
			[CLSCompliant(false)]public void CopyBytes(UInt16 value, Array destinationArray, int destinationIndex)
			{
			...
			[CLSCompliant(false)]public void CopyBytes(UInt32 value, Array destinationArray, int destinationIndex)
			{
			...
			[CLSCompliant(false)]public void CopyBytes(UInt64 value, Array destinationArray, int destinationIndex)
			{
