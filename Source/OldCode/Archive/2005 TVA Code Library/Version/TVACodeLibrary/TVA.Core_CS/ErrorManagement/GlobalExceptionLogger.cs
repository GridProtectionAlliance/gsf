...
namespace TVA
{
	namespace ErrorManagement
	{
		...
		/// </remarks>
		[ToolboxBitmap(typeof(GlobalExceptionLogger))]public partial class GlobalExceptionLogger : IPersistSettings, ISupportInitialize
		{
			...
			[Category("Behavior"), DefaultValue(DefaultAutoRegister)]public bool AutoRegister
			{
				get
				{
			...
			[Category("Behavior"), DefaultValue(DefaultExitOnUnhandledException)]public bool ExitOnUnhandledException
			{
				get
				{
			...
			[Category("Logging"), DefaultValue(DefaultLogToUI)]public bool LogToUI
			{
				get
				{
					return m_logToUI;
			...
			[Category("Logging"), DefaultValue(DefaultLogToFile)]public bool LogToFile
			{
				get
				{
					return m_logToFile;
			...
			[Category("Logging"), DefaultValue(DefaultLogToEmail)]public bool LogToEmail
			{
				get
				{
					return m_logToEmail;
			...
			[Category("Logging"), DefaultValue(DefaultLogToEventLog)]public bool LogToEventLog
			{
				get
				{
			...
			[Category("Logging"), DefaultValue(DefaultLogToScreenshot)]public bool LogToScreenshot
			{
				get
				{
			...
			[Category("Settings"), DefaultValue(DefaultSmtpServer)]public string SmtpServer
			{
				get
				{
					return m_smtpServer;
			...
			[Category("Settings"), DefaultValue(DefaultContactName)]public string ContactName
			{
				get
				{
			...
			[Category("Settings"), DefaultValue(DefaultContactEmail)]public string ContactEmail
			{
				get
				{
			...
			[Category("Settings"), DefaultValue(DefaultContactPhone)]public string ContactPhone
			{
				get
				{
			...
			[Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]public System.Reflection.Assembly ParentAssembly
			{
				get
				{
			...
			[Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]public UITextMethodSignature ErrorTextMethod
			{
				get
				{
			...
			[Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]public UITextMethodSignature ScopeTextMethod
			{
				get
				{
			...
			[Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]public UITextMethodSignature ActionTextMethod
			{
				get
				{
			...
			[Browsable(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]public UITextMethodSignature MoreInfoTextMethod
			{
				get
				{
			...
			[Browsable(false)]public string ApplicationName
			{
				get
				{
			...
			[Browsable(false)]public ApplicationType ApplicationType
			{
				get
				{
			...
			[Browsable(false)]public LogFile LogFile
			{
				get
				{
					return _LogFile;
			...
			[Browsable(false)]public Exception LastException
			{
				get
				{
			...
			[Browsable(false)]public List<LoggerMethodSignature> Loggers
			{
				get
				{
					return m_loggers;
			...
			private void ExceptionToEmail(Exception exception)
			{
				...
				if (m_logToEmail && ! string.IsNullOrEmpty(m_contactEmail))
				{
					try
					{
						...
						with_1.Subject = string.Format("Exception in {0} at {1}", ApplicationName, System.DateTime.Now.ToString());
			...
			public static string SystemInfo()
			{
				...
				System.Text.StringBuilder with_1 = new StringBuilder();
				with_1.AppendFormat("Date and Time:         {0}", System.DateTime.Now);
				with_1.AppendLine();
				switch (TVA.Common.GetApplicationType())
				{
					case TVA.ApplicationType.WindowsCui:
			...
			public static string ExceptionStackTrace(Exception ex)
			{
				...
				for (int i = 0; i <= stack.FrameCount - 1; i++)
				{
					...
					else
					{
						...
						{
							with_1.Append(System.IO.Path.GetFileName(TVA.Assembly.EntryAssembly.CodeBase));
						}
						else
						{
			...
			private static string ApplicationInfo(System.Reflection.Assembly parentAssembly)
			{
				...
				System.Text.StringBuilder with_1 = new StringBuilder();
				TVA.Assembly parentAssemblyInfo = new TVA.Assembly(parentAssembly);
