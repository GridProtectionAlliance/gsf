	...
	namespace Net
	{
		namespace Ftp
		{
			...
			public class Exception : System.Exception
			{
				...
				internal Exception(string message, Response ftpResponse) : base(message)
				{
			...
			public class FileNotFoundException : Exception
			{
				...
				internal FileNotFoundException(string remoteFile) : base("Remote file (" + remoteFile + ") not found.  Try refreshing the directory.")
				{
			...
			public class DataTransferException : Exception
			{
				...
				internal DataTransferException() : base("Data transfer error: previous transfer not finished.")
				{
			...
			public class UserAbortException : Exception
			{
				...
				internal UserAbortException() : base("File Transfer aborted by user.")
				{
