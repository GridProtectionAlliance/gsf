        ...
        Public Overridable ReadOnly Property Status() As String
            Get
                ...
                With New StringBuilder
                    ...
                    .AppendLine()
                    .Append("  Frame queue missed locks: ")
                    .Append(m_frameQueue.MissedLocks)
                    .AppendLine()
                    .Append(" Frame queue lock attempts: ")
                    .Append(m_frameQueue.LockAttempts)
                    .AppendLine()
                    .Append("  Frame queue lock failure: ")
                    .Append((m_frameQueue.MissedLocks / m_frameQueue.LockAttempts).ToString("##0.0000%"))
                    .AppendLine()
                    ...
                    .Append(" frames/sec")
                    .AppendLine()
                    .Append("        Queued frame count: ")
                    .Append(m_frameQueue.Count)
                    .AppendLine()
                    .AppendLine()
