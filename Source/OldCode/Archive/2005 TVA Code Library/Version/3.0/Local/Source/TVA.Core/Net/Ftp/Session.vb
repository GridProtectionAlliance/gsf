...
Namespace Net.Ftp
    ...
    <ToolboxBitmap(GetType(Session)), DisplayName("FtpSession"), DefaultProperty("Server"), DefaultEvent("FileTransferProgress"), Description("Creates a client connection to an FTP server")> _
