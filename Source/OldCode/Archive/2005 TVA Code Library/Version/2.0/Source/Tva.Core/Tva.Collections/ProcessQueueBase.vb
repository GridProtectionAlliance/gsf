...
Namespace Collections
    ...
    ''' <summary>
    ''' <para>This is the base class used for processing a queue of items</para>
    ''' </summary>
    ''' <typeparam name="T">Type of object to process</typeparam>
    ''' <remarks>
    ''' <para>This class acts as a strongly typed queue of objects to be processed.</para>
    ...
    Public MustInherit Class ProcessQueueBase(Of T)
        ...
        Public Sub AddRange(ByVal collection As IEnumerable(Of T))
            ...
            SyncLock SyncRoot
                InternalQueue.AddRange(collection)
            End SyncLock
        ...
        Protected ReadOnly Property InternalQueue() As List(Of T)
            Get
                Return DirectCast(InternalList, List(Of T))
            End Get
        End Property
