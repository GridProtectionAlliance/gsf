...
Namespace IeeeC37_118
    ...
    Public Class HeaderFrame
        ...
        Public Sub New()
            ...
            MyClass.New(IeeeC37_118.RevisionNumber.RevisionV1)
        ...
        Public Property TimeBase() As Int32 Implements ICommonFrameHeader.TimeBase
            ...
            Friend Set(ByVal value As Int32)
                ' Time base is readonly for header frames - we don't throw an exception here if someone attempts to change
                ' the time base on a header frame (e.g., the CommonFrameHeader.Clone method will attempt to copy this property)
                ' but we don't do anything with the value either.
            End Set
        End Property
