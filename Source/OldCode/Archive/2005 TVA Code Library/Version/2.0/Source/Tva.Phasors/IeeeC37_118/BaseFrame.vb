'*******************************************************************************************************
'  BaseFrame.vb - Basic PC37_118 Frame
...
Namespace IeeeC37_118
    ...
    ' This class represents the common definition of all the PC37_118 message frames that can be sent from a PMU.
    Public MustInherit Class BaseFrame
        ...
        Public Property FrameType() As FrameType
            ...
            End Get
            Protected Set(ByVal value As FrameType)
                m_sampleCount = (m_sampleCount And Not FrameTypeMask) Or value
            End Set
        End Property
