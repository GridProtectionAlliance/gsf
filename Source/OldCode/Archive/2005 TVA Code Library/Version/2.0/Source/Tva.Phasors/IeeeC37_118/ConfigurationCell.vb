...
Namespace IeeeC37_118
    ...
    Public Class ConfigurationCell
        ...
        Public Sub New(ByVal parent As IConfigurationFrame, ByVal nominalFrequency As LineFrequency)
            ...
            MyBase.New(parent, False, MaximumPhasorValues, MaximumAnalogValues, MaximumDigitalValues, nominalFrequency)
        ...
        Public Sub New(ByVal parent As IConfigurationFrame, ByVal nominalFrequency As LineFrequency, ByVal state As IConfigurationFrameParsingState, ByVal index As Integer, ByVal binaryImage As Byte(), ByVal startIndex As Integer)
            ...
            MyBase.New(parent, False, MaximumPhasorValues, MaximumAnalogValues, MaximumDigitalValues, nominalFrequency, New ConfigurationCellParsingState(GetType(PhasorDefinition), GetType(FrequencyDefinition), GetType(AnalogDefinition), GetType(DigitalDefinition)), binaryImage, startIndex)
