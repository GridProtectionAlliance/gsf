...
Namespace IeeeC37_118
    ...
    Public Class FrameParser
        ...
        Public Event RawData(ByVal buffer As Byte(), ByVal startIndex As Integer, ByVal length As Integer)
        ...
        Private Sub ReadDataStream()
            ...
            Do While True
                ...
                Do Until startIndex >= received
                    ...
                    RaiseEvent RawData(buffer, startIndex, parsedFrameHeader.FrameLength)
