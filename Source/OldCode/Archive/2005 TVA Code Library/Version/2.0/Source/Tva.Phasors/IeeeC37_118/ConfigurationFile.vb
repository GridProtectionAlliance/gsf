'*******************************************************************************************************
'  ConfigurationFile.vb - PC37_118 Configuration File
...
Namespace IeeeC37_118
    ...
    Public Class ConfigurationFile
        ...
        Public Const MaximumFrameCount As Int16 = 0 'ConfigurationFrame.MaximumFrameCount
            ...
            Set(ByVal Value As Int16)
                ...
                Else
                    ...
                    For x As Integer = 0 To Frames.Length - 1
                        Frames(x) = New ConfigurationFrame(Me)
                        With Frames(x)
                            '.IsFirstFrame = (x = 0)
