'	testSsamApi
'
'	this is a test class for the SsamApi class. See TvaTestClass for overview.
'
Imports TvaTestingLibrary
Imports SsamLibrary

Public Class testSsamApi
	Inherits TvaTestClass
	...
	Public Sub testDbConnectionsViaInit()
		...
		For iDbNumber = SsamDatabase.ssamProductionDB To SsamDatabase.ssamClusterDB
			oSsamApi.init(iDbNumber)			 'change databases
