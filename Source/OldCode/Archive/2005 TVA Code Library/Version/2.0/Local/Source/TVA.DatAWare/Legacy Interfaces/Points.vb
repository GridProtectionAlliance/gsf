...
Public Class Points
    ...
    Public ReadOnly Property Definition(ByVal databaseIndex As Integer) As DatabaseStructure
        Get
            ...
            Dim buffer As Byte() = CreateArray(Of Byte)(DatabaseStructure.BinaryLength)
            'Dim eof As Boolean
            'Dim errorMessage As String
    ...
    Public Sub ArchiveValue(ByVal databaseIndex As Integer, ByVal utcTimestamp As Date, ByVal value As Single, ByVal qual As Quality)
    ...
    Default Public ReadOnly Property Value(ByVal databaseIndex As Integer, Optional ByVal timeRequest As String = "*", Optional ByVal timeInterval As Single = 0) As StandardEvent
        Get
            ...
            Dim buffer As Byte() = CreateArray(Of Byte)(ProcessEvent.BinaryLength)
            'Dim errorMessage As String
