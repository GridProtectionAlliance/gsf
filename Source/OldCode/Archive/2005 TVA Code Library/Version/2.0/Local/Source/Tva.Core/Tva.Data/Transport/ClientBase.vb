...
Namespace Data.Transport
    ...
    Public MustInherit Class ClientBase
        ...
        <Description("The passpharse that will provided to the server for authentication during the handshake process."), Category("Configuration"), DefaultValue(GetType(Boolean), "True")> _
