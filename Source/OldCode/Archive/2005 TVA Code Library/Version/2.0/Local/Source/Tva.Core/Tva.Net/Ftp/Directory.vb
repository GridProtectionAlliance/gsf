...
Namespace Ftp
    ...
    Public Class Directory
        ...
        Private m_subDirectories As Dictionary(Of String, Directory)
        Private m_files As Dictionary(Of String, File)
        ...
        Public ReadOnly Property SubDirectories() As Dictionary(Of String, Directory).ValueCollection
            Get
                InitHashtable()
        ...
        Public ReadOnly Property Files() As Dictionary(Of String, File).ValueCollection
            Get
                InitHashtable()
        ...
        Public Overloads Sub GetFile(ByVal localFile As String, ByVal remoteFile As String)
            ...
            Dim file As File = m_files(remoteFile)
        ...
        Private Sub InitHashtable()
            ...
            If m_subDirectories Is Nothing Then
                If m_caseInsensitive Then
                    m_subDirectories = New Dictionary(Of String, Directory)(StringComparer.CurrentCultureIgnoreCase) ' New Hashtable(CaseInsensitiveComparer.Default)
                Else
                    m_subDirectories = New Dictionary(Of String, Directory)(StringComparer.CurrentCulture) ' New Hashtable
                End If
            End If

            If m_files Is Nothing Then
                If m_caseInsensitive Then
                    m_files = New Dictionary(Of String, File)(StringComparer.CurrentCultureIgnoreCase) ' New Hashtable(CaseInsensitiveHashCodeProvider.Default, CaseInsensitiveComparer.Default)
                Else
                    m_files = New Dictionary(Of String, File)(StringComparer.CurrentCulture) ' New Hashtable
                End If
            End If
