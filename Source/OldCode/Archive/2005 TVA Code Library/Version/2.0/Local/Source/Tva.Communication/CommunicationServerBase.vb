...
Public MustInherit Class CommunicationServerBase
    ...
    Public Property ConfigurationString() As String Implements ICommunicationServer.ConfigurationString
        Get
    ...
    Public Property MaximumClients() As Integer Implements ICommunicationServer.MaximumClients
        Get
    ...
    Public Property SecureSession() As Boolean Implements ICommunicationServer.SecureSession
        Get
    ...
    Public Property Handshake() As Boolean Implements ICommunicationServer.Handshake
        Get
            Return m_handshake
        End Get
        Set(ByVal value As Boolean)
    ...
    Public Property HandshakePassphrase() As String Implements ICommunicationServer.HandshakePassphrase
        Get
    ...
    Public Property ReceiveBufferSize() As Integer Implements ICommunicationServer.ReceiveBufferSize
        Get
    ...
    Public Property Encryption() As Tva.Security.Cryptography.EncryptLevel Implements ICommunicationServer.Encryption
        Get
            Return m_encryption
        End Get
    ...
    Public Property Compression() As Tva.IO.Compression.CompressLevel Implements ICommunicationServer.Compression
        Get
    ...
    Public Property Enabled() As Boolean Implements ICommunicationServer.Enabled
        Get
            Return m_enabled
        End Get
        Set(ByVal value As Boolean)
    ...
    <Browsable(False)> _
    Public Property TextEncoding() As Encoding Implements ICommunicationServer.TextEncoding
        Get
    ...
    <Browsable(False)> _
    Public Property Protocol() As TransportProtocol Implements ICommunicationServer.Protocol
        Get
            Return m_protocol
        End Get
    ...
    <Browsable(False)> _
    Public ReadOnly Property ServerID() As Guid Implements ICommunicationServer.ServerID
        Get
            Return m_serverID
        End Get
    End Property
    ...
    <Browsable(False)> _
    Public ReadOnly Property ClientIDs() As List(Of Guid) Implements ICommunicationServer.ClientIDs
        Get
            Return m_clientIDs
        End Get
    End Property
    ...
    <Browsable(False)> _
    Public ReadOnly Property IsRunning() As Boolean Implements ICommunicationServer.IsRunning
        Get
            Return m_isRunning
        End Get
    End Property
    ...
    <Browsable(False)> _
    Public ReadOnly Property RunTime() As Double Implements ICommunicationServer.RunTime
        Get
