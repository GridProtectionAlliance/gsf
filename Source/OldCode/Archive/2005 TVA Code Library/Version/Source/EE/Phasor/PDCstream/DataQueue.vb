        ...
        Public Sub SortDataPoint(ByVal dataPoint As PMUDataPoint)
            ...
            With dataPoint
                ...
                Catch ex As Exception
                    Throw New InvalidOperationException("Error sorting data point " & .PMU.ID & "-" & [Enum].GetName(GetType(PointType), .Type) & .Index & "@" & .Timestamp.ToString("dd-MMM-yyyy HH:mm:ss.fff") & ": " & ex.Message, ex)
                End Try
            End With
