...
Namespace Ftp
    ...
    <ToolboxBitmap(GetType(FileWatcher), "FileWatcher.bmp"), DefaultProperty("Server"), DefaultEvent("FileAdded")> _
        ...
        Private Sub WatchTimer_Elapsed(ByVal sender As Object, ByVal e As System.Timers.ElapsedEventArgs) Handles WatchTimer.Elapsed
            ...
            If Not FtpSession Is Nothing Then
                If FtpSession.IsConnected Then
                    ...
                    Dim Files As IDictionaryEnumerator = FtpSession.CurrentDirectory.Files.GetEnumerator()
