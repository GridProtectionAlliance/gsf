...
Namespace Remoting
    ...
    <Serializable(), ToolboxBitmap(GetType(SoapClient), "SoapClient.bmp"), DefaultEvent("ServerNotification"), DefaultProperty("URI")> _
    Public Class SoapClient
        ...
        Public Sub New()
            ...
            MyBase.New()
            URI = "tcp://localhost:8090/SoapServerURI"
        ...
        Public Overrides ReadOnly Property Description() As String
            Get
                Return "Soap " & MyBase.Description
            End Get
        End Property
        ...
        Public Overrides Function CreateServerProviderChain() As IServerChannelSinkProvider
            ...
            Dim formatter As New SoapServerFormatterSinkProvider
