...
Namespace Remoting
    ...
    <Serializable(), ToolboxBitmap(GetType(SoapServer), "SoapServer.bmp"), DefaultEvent("ClientNotification"), DefaultProperty("HostID")> _
...
#End If
        ...
        Public Overrides ReadOnly Property ClientType() As String
            Get
                Return GetType(SoapClient).FullName
            End Get
        End Property
