            ...
            private class CommonFrameHeaderInstance : ICommonFrameHeader
            {
                ...
                public Dictionary<string, string> Attributes
                {
                    get
                    {
                        ...
                        m_attributes.Add("Time Quality Flags", (int)TimeQualityFlags + ": " + Enum.GetName(typeof(TimeQualityFlags), TimeQualityFlags));
                        m_attributes.Add("Time Quality Indicator Code", (int)TimeQualityIndicatorCode + ": " + Enum.GetName(typeof(TimeQualityIndicatorCode), TimeQualityIndicatorCode));
