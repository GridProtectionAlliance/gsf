...
//*******************************************************************************************************
//  AnalogDefinitionCollection.vb - Analog value collection class
...
{
    /// <summary>This class represents the common implementation collection of protocol independent definitions of analog values.</summary>
    ...
    public class AnalogDefinitionCollection : ChannelDefinitionCollectionBase<IAnalogDefinition>
    {
        ...
        public AnalogDefinitionCollection(int maximumCount)
            : base(maximumCount)
        {
