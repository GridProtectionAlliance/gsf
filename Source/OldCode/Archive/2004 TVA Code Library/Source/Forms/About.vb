...
#End Region
    ...
    Private Sub About_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        With Me
            ...
            Debug.WriteLine(AppDomain.CurrentDomain().SetupInformation().ApplicationName())
            ...
            For Each oAssemblyName As Reflection.AssemblyName In Reflection.Assembly.GetExecutingAssembly().GetReferencedAssemblies()
                .cboAssemblies.Items.Add(oAssemblyName.Name())
            Next
    ...
    Private Sub llHomePage_LinkClicked(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles llHomePage.LinkClicked
        ...
        Process.Start("http://opweb.cha.tva.gov/home/frameload.htm")
    ...
    Private Function GetAssembly(ByVal AssemblyName As String) As Reflection.Assembly
        ...
        Return Reflection.Assembly.LoadWithPartialName(AssemblyName)
