'***********************************************************************
'  PhasorDataSample.vb - Phasor data sample class
...
Namespace EE.Phasor
    ...
    Public Class PhasorDataSample

        Implements IComparable

        Private m_phasorDataFrames As PhasorDataFrameCollection
        ...
        Public Sub New()
            ...
            m_phasorDataFrames = New PhasorDataFrameCollection
        ...
        Public Overridable ReadOnly Property PhasorDataFrames() As PhasorDataFrameCollection
            Get
                Return m_phasorDataFrames
            End Get
        End Property
        ...
        Public Overridable ReadOnly Property Published() As Boolean
            Get
                If Not m_published Then
                    If m_phasorDataFrames.Count > 0 Then
                        Dim allPublished As Boolean = True

                        ' The sample has been completely processed once all data frames have been published
                        For x As Integer = 0 To m_phasorDataFrames.Count - 1
                            If Not m_phasorDataFrames(x).Published Then
                                allPublished = False
                                Exit For
                            End If
                        Next
        ...
        Public Overridable Function CompareTo(ByVal obj As Object) As Integer Implements System.IComparable.CompareTo
            ...
            If TypeOf obj Is PhasorDataSample Then
                Return m_timestamp.CompareTo(DirectCast(obj, PhasorDataSample).Timestamp)
            Else
                Throw New ArgumentException("PhasorDataSample can only be compared with other PhasorDataSamples...")
            End If
