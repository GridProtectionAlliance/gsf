...
Public Class PMUServerPoints
    ...
    Public Sub New(ByVal concentrator As Concentrator, ByVal connection As DatAWare.Connection, ByVal userName As String, ByVal password As String)
    ...
    Public ReadOnly Property Concentrator() As Concentrator
        Get
    ...
    Public Shared Function DefinePMUDataPoint(ByVal configFile As ConfigFile, ByVal synonym As String) As PMUDataPoint
