...
Public Class ConsoleMonitor
    ...
    Private Const AuthenticationKey As String = "498BF815-2613-4BFD-82BB-138A1633D862"
    Private Const SourceConfigFile As String = "DatAWare PDC.exe.config"
    Private Const HostName As String = "DatAWarePDC"
    Private Const HostURI As String = "tcp://localhost:6500/DatAWarePDC"
...
#End Region
    ...
    Public Shared Sub Main()
        ...
        If Len(Variables(VariablePrefix & ".HostURI").ToString()) > 0 Then
            RemoteMonitor = New RemoteServiceMonitor(New SecureClient(Variables(VariablePrefix & ".HostURI"), AuthenticationKey))
