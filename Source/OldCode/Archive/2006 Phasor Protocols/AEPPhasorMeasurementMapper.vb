'*******************************************************************************************************
'  AEPPhasorMeasurementMapper.vb - AEP frequency and magnitude data corrective measurement mapper
...
Public Class AEPPhasorMeasurementMapper
    ...
    Protected Overrides Sub MapDataFrameMeasurements(ByVal frame As IDataFrame)
        ...
        ' AEP's configuration frame is bad - right we only try to correct frequenct offsets
        With frame
            Dim x, y As Integer
