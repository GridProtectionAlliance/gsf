...
Public Class StatusWindow
    ...
    Private Const MaximumStatusLength As Integer = 1048576

    Public ParentInterface As [Interface]
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.ServiceStatusLabel.Text = "DatAWare Phasor Data DAQ Service Status:"
        '
        'VersionLabel
        '
...
#End Region
    ...
    Public Sub SetInstance(ByVal instance As Integer)

        ServiceStatusLabel.Text &= " [Instance " & instance & "]"
    ...
    Private Sub StatusText_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles StatusText.DoubleClick
        ...
        UpdateStatus(ParentInterface.GetStatus())
