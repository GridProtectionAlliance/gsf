...
Public Class PhasorMeasurementMapper
    ...
    Public Sub New(ByVal frameParser As MultiProtocolFrameParser, ByVal source As String, ByVal pmuIDs As List(Of String), ByVal measurementIDs As Dictionary(Of String, MeasurementDefinition))
    ...
    Private Sub m_frameParser_AttemptingConnection() Handles m_frameParser.AttemptingConnection
        ...
        With m_frameParser
            UpdateStatus("Attempting " & [Enum].GetName(GetType(PhasorProtocol), m_frameParser.PhasorProtocol).ToUpper() & " " & [Enum].GetName(GetType(TransportProtocol), .TransportProtocol).ToUpper() & " based connection to PDC/PMU " & .ConnectionName)
        End With
