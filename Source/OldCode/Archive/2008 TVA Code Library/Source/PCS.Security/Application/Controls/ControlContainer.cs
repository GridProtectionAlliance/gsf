...
//*******************************************************************************************************
//  PCS.Security.Application.Controls.ControlContainer.vb - Container control for user input controls
		...
		namespace Controls
		{
			...
			public class ControlContainer : CompositeControl
			{
				...
				protected override void CreateChildControls()
				{
					...
					string includeLocation = Page.ClientScript.GetWebResourceUrl(typeof(ControlContainer), "PCS.Security.Application.Controls.StyleSheet.css");
					...
					headerImage.ImageUrl = Page.ClientScript.GetWebResourceUrl(typeof(ControlContainer), "PCS.Security.Application.Controls.LogoExternal.jpg");
					...
					imageLinkText = string.Format(imageLinkText, Page.ClientScript.GetWebResourceUrl(typeof(ControlContainer), "PCS.Security.Application.Controls.Help.pdf"), Page.ClientScript.GetWebResourceUrl(typeof(ControlContainer), "PCS.Security.Application.Controls.Help.gif"));
