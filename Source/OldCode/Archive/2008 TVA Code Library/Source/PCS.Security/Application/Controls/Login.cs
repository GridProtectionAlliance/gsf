...
//*******************************************************************************************************
//  PCS.Security.Application.Controls.Login.vb - Control for logging in to a web site
					...
					try
					{
						if (m_securityProvider != null)
						{
							...
							if (user.IsAuthenticated)
							{
								...
								string username = PCS.Security.Cryptography.Common.Encrypt(m_usernameTextBox.Text);
								string password = PCS.Security.Cryptography.Common.Encrypt(m_passwordTextBox.Text);
