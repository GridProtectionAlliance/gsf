...
//*******************************************************************************************************
//  PCS.Security.Application.SecurityProviderBase.vb - Base class for application security provider
...
//       authentication.
//       Implemented PCS.Configuration.IPersistSettings interface to allow for the property values to
...
namespace PCS.Security
{
	namespace Application
	{
		...
		/// </summary>
		[ProvideProperty("ValidRoles", typeof(object)), ProvideProperty("ValidRoleAction", typeof(object))]public abstract partial class SecurityProviderBase : IExtenderProvider, ISupportInitialize, PCS.Configuration.IPersistSettings
		{
			...
			/// </summary>
			/// <value></value>
			/// <returns>One of the PCS.Security.Application.SecurityServer values.</returns>
			...
			/// </summary>
			/// <value></value>
			/// <returns>One of the PCS.Security.Application.AuthenticationMode values.</returns>
			...
			/// </summary>
			/// <value></value>
			/// <returns>Instance of PCS.Security.Application.User class.</returns>
			...
			public virtual void LoadSettings()
			{
				...
				if (m_persistSettings)
				{
					try
					{
						PCS.Configuration.CategorizedSettingsElement with_1 = PCS.Configuration.Common.CategorizedSettings(m_settingsCategory);
