...
namespace PCS.Web
{
	namespace UI
	{
		...
		public class SecureMasterPage : System.Web.UI.MasterPage
		{
			...
			/// <summary>
			/// Initializes a new instance of PCS.Web.UI.SecureMasterPage class.
			/// </summary>
			...
			/// <summary>
			/// Gets the PCS.Security.Application.WebSecurityProvider component that handles the security.
			/// </summary>
			/// <value></value>
			/// <returns>The PCS.Security.Application.WebSecurityProvider component.</returns>
			...
			/// <summary>
			/// Raises the PCS.Web.UI.SecureMasterPage.LoginSuccessful event.
			/// </summary>
			...
			/// <summary>
			/// Raises the PCS.Web.UI.SecureMasterPage.LoginUnsuccessful event.
			/// </summary>
			/// <param name="e">A System.ComponentModel.CancelEventArgs that contains the event data.</param>
			/// <remarks>
