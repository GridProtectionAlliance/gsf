...
namespace PCS.Parsing
{
    ...
    public abstract class OldParserBase<TSourceIdentifier, TTypeIdentifier, TOutputType> : Component, ISupportLifecycle, ISupportInitialize, IPersistSettings where TOutputType : IBinaryImageConsumer<TTypeIdentifier>
    {
        #region [ Members ]
