...
//      Migrated 2.0 version of source code from 1.1 source (PCS.Shared.Assembly).
...
namespace PCS.Reflection
{
    ...
    public class AssemblyInfo
    {
        ...
        /// <summary>Initializes an instance of PCS.AssemblyInformation for the specified Assembly.</summary>
        /// <param name="assemblyInstance">An instance of Assembly for which a PCS.AssemblyInformation instance is to be created.</param>
        ...
        /// <summary>Gets the PCS.Assembly instance of the assembly that invoked the currently executing method.</summary>
        /// <returns>The PCS.Assembly instance of the assembly that invoked the currently executing method.</returns>
        ...
        /// <summary>Gets the PCS.Assembly instance of the process executable in the default application domain.</summary>
        /// <returns>The PCS.Assembly instance of the process executable in the default application domain.</returns>
        ...
        /// <summary>Gets the PCS.Assembly instance of the assembly that contains the code that is currently executing.</summary>
        /// <returns>The PCS.Assembly instance of the assembly that contains the code that is currently executing.</returns>
        ...
        /// <remarks>This cannot be used to load PCS.Core itself.</remarks>
