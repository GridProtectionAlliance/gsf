...
using PCS.IO.Compression.Core;
using PCS.IO.Compression.Zip.Algorithms;
using PCS.IO.Compression.Zip.Algorithms.Streams;
using PCS.Security.Cryptography.Pkzip;

namespace PCS.IO.Compression.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="PCS.IO.Compression.Zip.ZipException">
