...
//       Migrated 2.0 version of source code from 1.1 source (PCS.ErrorManagement.SmtpTraceListener).
...
namespace PCS.ErrorManagement
{
    ...
    ///     <trace>
    ///       <listeners>
    ///         <add name="SmtpTraceListener" type="PCS.ErrorManagement.SmtpTraceListener,PCS.Core" initializeData="sender@email.com,recipient@email.com,smtp.email.com"/>
    ///       </listeners>
    ///     </trace>
    ///   </system.diagnostics>
    /// </configuration>
