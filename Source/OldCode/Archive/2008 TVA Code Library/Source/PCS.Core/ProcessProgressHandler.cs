...
{
    /// <summary>
    /// Defines a delegate handler for a <see cref="PCS.ProcessProgress{TUnit}"/> instance.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <para>
    /// Examples include:
    /// <see cref="PCS.IO.Compression.CompressionExtensions.Compress(System.IO.Stream,System.IO.Stream,PCS.IO.Compression.CompressionStrength,Action{PCS.ProcessProgress{long}})"/>, 
    /// <see cref="PCS.Security.Cryptography.Cipher.Encrypt(System.IO.Stream,System.IO.Stream,byte[],byte[],PCS.Security.Cryptography.CipherStrength,Action{PCS.ProcessProgress{long}})"/> and
    /// <see cref="PCS.Security.Cryptography.Cipher.Decrypt(System.IO.Stream,System.IO.Stream,byte[],byte[],PCS.Security.Cryptography.CipherStrength,Action{PCS.ProcessProgress{long}})"/>
    /// </para>
    /// </remarks>
    ...
    public class ProcessProgressHandler<TUnit> where TUnit : struct
    {
        ...
        /// <summary>
        /// Gets instance of <see cref="PCS.ProcessProgress{TUnit}"/> used to track progress for this handler.
        /// </summary>
        ...
        /// property value is assigned, the callback function is automatically called with updated <see cref="PCS.ProcessProgress{TUnit}"/>
        ...
        /// <summary>
        /// Calls callback function with updated <see cref="PCS.ProcessProgress{TUnit}"/> instance so consumer can track progress.
        /// </summary>
