...
namespace PCS.Configuration
{
    ...
    public class ConfigurationFile
    {
        ...
        private const string CustomSectionType = "PCS.Configuration.CategorizedSettingsSection, PCS.Core";
        ...
        /// <summary>
        /// Writes the configuration settings contained within this PCS.Configuration.ConfigurationFile object
        ...
        private System.Configuration.Configuration GetConfiguration(string configFilePath)
        {
            ...
            if (configFilePath != null)
            {
                if (configFilePath == "" || Path.GetExtension(configFilePath) == ".config")
                {
                    ...
                    switch (PCS.Common.GetApplicationType())
                    {
