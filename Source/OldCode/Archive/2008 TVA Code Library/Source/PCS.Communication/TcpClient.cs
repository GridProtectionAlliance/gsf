    ...
    public class TcpClient : ClientBase
    {
        ...
        private void ReceivePayloadAwareAsyncCallback(IAsyncResult asyncResult)
        {
            ...
            else
            {
                ...
                {
                    // Connection lost so we'll process it's disconnect.
...
//        /// <summary>
//        /// Initializes a instance of PCS.Communication.TcpClient with the specified data.
//        /// </summary>
...
//            {
//#if ThreadTracking
//                m_connectionThread = new PCS.Threading.ManagedThread(ConnectToServer);
//                m_connectionThread.Name = "PCS.Communication.TcpClient.ConnectToServer()";
//#else
...
//                        receiveThread.Name = "PCS.Communication.TcpClient.ReceiveServerData() [" + m_tcpClient.ID.ToString() + "]";
//#else
