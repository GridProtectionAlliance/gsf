...
Namespace Database
    ...
    Public MustInherit Class BulkDataOperationBase
        ...
        Private m_excludedTables As New List(Of String)
        ...
        Public ReadOnly Property ExcludedTables() As List(Of String)
            Get
        ...
        Public Overridable Sub Analyze()
            ...
            For Each tbl In schFrom.Tables
                ...
                If m_excludedTables.BinarySearch(tbl.MapName) < 0 Then
