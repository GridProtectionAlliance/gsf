...
@ECHO OFF
C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\msbuild.exe TimeSeriesFramework.buildproj /l:FileLogger,Microsoft.Build.Engine;logfile=TimeSeriesFramework.output