...
namespace NAudioWpfDemo
{
    class ControlPanelViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public ControlPanelViewModel(IWaveFormRenderer waveFormRenderer)
        {
            ...
            audioGraph.GotSongList += new EventHandler<TVA.EventArgs<List<string>>>(audioGraph_GotSongList);
            audioGraph.PlaybackStateChanged += new EventHandler<TVA.EventArgs<PlaybackState, string>>(audioGraph_PlaybackStateChanged);
