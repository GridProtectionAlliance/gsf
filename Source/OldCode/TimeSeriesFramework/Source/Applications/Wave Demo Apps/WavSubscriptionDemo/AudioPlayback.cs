...
namespace NAudioWpfDemo
{
    ...
    class AudioPlayback : IDisposable
    {
        ...
        private void DataSubscriber_StatusMessage(object sender, TVA.EventArgs<string> e)
        {
            Console.WriteLine(e.Argument);
        }

        // Handles the subscriber's ProcessException event.
        private void DataSubscriber_ProcessException(object sender, TVA.EventArgs<Exception> e)
        {
        ...
        private void DataSubscriber_NewMeasurements(object sender, TVA.EventArgs<ICollection<TimeSeriesFramework.IMeasurement>> e)
        {
            // Gather statistics.
        ...
        private void StatTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            if (StatsUpdated != null && m_periodIndexCount > 0)
            {
