...
namespace TVA.Communication
{
    ...
    public class TcpClient : ClientBase
    {
        ...
        public override int Read(byte[] buffer, int startIndex, int length)
        {
            ...
            {
                int sourceLength = m_tcpClient.ReceiveBufferLength;
        ...
        private void ConnectAsyncCallback(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                if (Handshake)
                {
                    ...
                    m_tcpClient.Provider.BeginSend(tcpClient.SendBuffer, 0, tcpClient.SendBufferLength, SocketFlags.None, SendPayloadAsyncCallback, m_tcpClient).AsyncWaitHandle.WaitOne();
