...
Namespace Database
    ...
    Public Class Common
        ...
        Public Shared Function NotNull(ByVal val As Object, Optional ByVal nonNullValue As String = Nothing) As String

            If nonNullValue Is Nothing Then
                Return TVA.Common.ToNonNullString(Of Object)(val)
            Else
                Return TVA.Common.ToNonNullString(Of Object)(val, nonNullValue)
            End If
