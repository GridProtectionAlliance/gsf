//******************************************************************************************************
// HistorianViewUserControl.xaml.cs - Gbtc
//
...
{
    /// <summary>
    /// Interaction logic for HistorianViewUserControl.xaml
    /// </summary>
    public partial class HistorianViewUserControl : UserControl
    {
        #region [ Members ]
        ...
        private ChartWindowUserControl m_chartWindow;
        private HistorianViewChart m_historianViewChart;
            ...
            private void InitializeChartWindow()
        {
            ...
            {
                m_chartWindow = new ChartWindowUserControl();
                m_chartWindow.ChartUpdated += ChartWindow_ChartUpdated;
                m_chartWindow.Unloaded += m_chartWindow_Unloaded;          //+=  ChildWindow_Closing;
                TrySetChartInterval(null);
            }
        }

        void m_chartWindow_Unloaded(object sender, RoutedEventArgs e)
        {
        ...
        private void TrendRequested()
        {
            ...
            if (TrySetChartInterval(chartIntervalErrorMessage))
            {
                ...
                m_chartWindow.UpdateChart();
                //m_historianViewChart.visiblePoints = m_metadata.Where(wrapper => wrapper.Display).Select(wrapper => wrapper.GetMetadata()).ToList();
                m_historianViewChart = new HistorianViewChart(m_chartWindow);
                m_historianViewChart.Show();
                m_historianViewChart.Focus();
               //CommonFunctions.LoadUserControl(m_chartWindow, "Historian View Chart");                
            }
        }
        ...
        private void Window_Closing(object sender, CancelEventArgs e)
        {
            ...
            ClearArchives();
            m_chartWindow.Unloaded -= m_chartWindow_Unloaded;
            //m_chartWindow.Close();
        }
